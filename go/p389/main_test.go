...
// failing test case during submission
func TestCase4(t *testing.T) {
    ...
    u := "" 
    ...
    if actual != expected {
        t.Fatalf("Case 4 failed: (%v, %v)", string(actual), string(expected))
    }
}
